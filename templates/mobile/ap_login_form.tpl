    ...
    <div class="int_b_content">
      ...
      <div class="row">
        ...
        <div class="form_input">
          <input type="text" class="inputTxt" id="inputEnterEmail" name="login" value="<%post:login%>" placeholder="<%cms_cons:Login%>"
      ...
      <div class="row">
        ...
        <div class="form_input">
          <input type="password" class="inputTxt" id="inputEnterPassword" name="passw" placeholder="<%cms_cons:Password%>"
            onkeypress="if(checkEnter(event)) {try_login(document.getElementById('inputEnterEmail').value, 'internal_login_form'); return false;}"
          />
        </div>
      </div>
