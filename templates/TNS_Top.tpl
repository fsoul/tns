...
<div id="main_internal_content_center_block_info">
    ...
    <div id="tns_top""><div class="error"><%nl2br_page_cms:plugin_error%></div>
        <div class="form_row">
    ...
    <div id="download_plugin_block" style="display:none;">
        <div>
            ...
            <br/><a class="button link" style="text-transform: none;" <%ap_download_plugin_link:TNS_Top%>>  <%page_cms:download_top_title%></a>
