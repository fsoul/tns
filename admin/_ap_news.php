...
//********************************************************************
	...
	if (!defined('ADMIN_MENU_ITEM_AP_NEWS')) define('ADMIN_MENU_ITEM_AP_NEWS', 'Access Panel Dictionaries/'.str_to_title($modul_title));

	//проверяем права и обрабатываем op='self_test', op='menu_array' 
	check_modul_rights(array(ADMINISTRATOR, POWERUSER), ADMIN_MENU_ITEM_AP_NEWS);
