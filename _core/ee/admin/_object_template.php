 ...
 */
	...
	$edit_config_height = 300;

	if (!defined('ADMIN_MENU_ITEM_OBJECT_TEMPLATE')) define('ADMIN_MENU_ITEM_OBJECT_TEMPLATE', 'Objects/Object template');

	//проверяем права и обрабатываем op='self_test', op='menu_array' 
	check_modul_rights(array(ADMINISTRATOR), ADMIN_MENU_ITEM_OBJECT_TEMPLATE);
 ...
 */
	...
	$mandatory=array('object_id', 'template_id');
	// тип поля ввода
	$type['id'] = "string";
	$type['object_id'] = "select_object";
	$type['template_id'] = "select_tpl_file";
