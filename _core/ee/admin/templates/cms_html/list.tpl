...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="tableborder">
	<tr bgcolor="#eeeeee" class="table_header">
		<td align="center" height="40">Choose language:&nbsp;<%print_avail_languages%> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Page title:&nbsp;&nbsp;<input type="text" value="<%field_name%>" name="aFieldName" size="40"></td>
	</tr>
	<tr>
...
&nbsp;&nbsp;<input type="button" value="Cancel" class="button" onclick="window.parent.closePopup()">&nbsp;&nbsp;<input type="submit" value="Save" name="save" class="button">
</form>
</body>
</html>
