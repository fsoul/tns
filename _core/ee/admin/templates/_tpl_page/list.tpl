...
function copy(code, type, name, add_url){
	frm=document.forms[0];

	if(confirm('Copy '+type.toLowerCase()+' '+name+'?')) {
		frm.action='<%:modul%>.php?page=<%:page%>&srt=<%get:srt%>&click=<%:click%>&op=copy&copy='+code+'&type='+type;
