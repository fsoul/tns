...
function wnd_showCalendar()
{
  ...
  {
    var calendarObject = new Calendar(true, null, dateSelected, closeHandler);
...
function closeHandler(calendarObject) 
{
  ...
  if(needReload) allReload();	//	пробуем добавить свою функциональность для перегрузки страницы
}
