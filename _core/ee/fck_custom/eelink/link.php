...
<html>
	<head>
		...
		<script src="<?echo EE_HTTP_PREFIX; ?>fckeditor/editor/dialog/common/fck_dialog_common.js" type="text/javascript"></script>
		<script src="<?echo EE_HTTP_PREFIX; ?>fck_custom/eelink/fck_link.js" type="text/javascript"></script>
<script>

function BrowseSatelites()
{
	var old_fckLink = FCKConfig.LinkBrowserURL;
	FCKConfig.LinkBrowserURL = '<?php echo EE_ADMIN_URL; ?>_assets.php?lang='+FCKConfig.lang+'&return_pages_for_fck=1&show_admin_menu=0&module_title_and_options=0&big_options=0&folder_menu=0&content_menu=0&hide_checkbox=1&hide_page_action=1&hide_checkbox=1&hide_page_edit=1&hide_page_autor=1&hide_view=1&hide_index=1&hide_cachable=1';
	...
	FCKConfig.LinkBrowserURL = old_fckLink;
}
	...
	<body scroll="no" style="OVERFLOW: hidden">
		<div id="divInfo" style="DISPLAY: none">
			...
			<div id="divLinkTypeUrl">
				...
				<input type="button" value="Browse Content" onclick="BrowseSatelites();" />
				</div>
			</div>
		...
		<div id="divUpload" style="DISPLAY: none">
			<form id="frmUpload" method="post" target="UploadWindow" enctype="multipart/form-data" action="" onsubmit="return CheckUpload();">
				...
				<iframe name="UploadWindow" style="DISPLAY: none" src="<?=EE_HTTP;?>fckeditor/editor/fckblank.html"></iframe>
			</form>
		</div>
