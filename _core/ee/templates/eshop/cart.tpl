	...
	<%print_cart_items%>			
	  ...
	  <tfoot>
        ...
        <tr>
          ...
          <td align="right"><strong><%tpl_money::amount_total%> <%cms:cart_carrency_lbl%></strong></td>
          <td></td>
        </tr>

        <tr>
          <td colspan="4" align="right"><strong><%cms_e:cart_VAT_lbl%></strong></td>
          <td align="right"><strong><%tpl_money::tax_total%> <%cms:cart_carrency_lbl%></strong></td>
          <td></td>
        </tr>
             
	<tr>
          <td colspan="4" align="right"><strong><%cms_e:cart_total_lbl%></strong></td>
          <td align="right"><strong><%tpl_money:<%tpl_add::amount_total,<%:tax_total%>%>%> <%cms_e:cart_carrency_lbl%></strong></td>
          <td></td>
        </tr>
