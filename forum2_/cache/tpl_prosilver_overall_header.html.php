...
<noscript>
<img
src="http://istat.tns.bemobile.ua/bug/pic.gif?siteid=opros.tns-ua.com"
...
(function(){
var i=new Image();
i.src="http://istat.tns.bemobile.ua/bug/pic.gif"+
"?siteid=opros.tns-ua.com"+
"&j=1&"+Math.random();
var p=document.getElementsByTagName('head')[0];
var s=document.createElement("script");
s.type="text/javascript";
s.src="http://source.tns.bemobile.ua/id/tns_id.js";
s.onload=s.onreadystatechange=function(){
if(!("readyState" in s)||/loaded|complete/.test(s.readyState)){
s.onload=s.onreadystatechange=null;
var s2=document.createElement("script");
s2.type="text/javascript";
s2.src="http://source.tns.bemobile.ua/cm/cmeter.js";
p.appendChild(s2);
}}
p.appendChild(s);
})();
